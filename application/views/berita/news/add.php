                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active breadcrumb-item text-success"><?= $title ?></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-10 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            // Notifikasi open
                            echo form_open_multipart(base_url('News/add'), 'class="form form-vertical"');
                            ?>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Judul Berita</label>
                                        <input type="text" class="form-control" name="judul_news" placeholder="Judul Berita" value="<?= set_value('judul_news') ?>" required />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Deskripsi Berita</label>
                                        <textarea name="deskripsi" id="ckeditor" rows="5" class="form-control" placeholder="Deskripsi Berita" required><?= set_value('deskripsi') ?></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
