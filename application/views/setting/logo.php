                ...
                <div class="col-10 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            // Notifikasi open
                            echo form_open_multipart(base_url('Setting/logo'), 'class="form form-vertical"');
                            ?>
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-8">
                                    <div class="form-group">
                                        <label>Upload Logo Website Terbaru</label>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <label>Gambar Logo Website Saat Ini: </label><br>
                                        <img src="<?php echo base_url('images/logo/thumbs/' . $setting->logo) ?>" class="img-thumbnail rounded" height="80" width="80">
                                    </div>
                                </div>
