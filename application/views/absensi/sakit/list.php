                    ...
                    <div class="card">
                            ...
                            <div class="card-tools">
                                <div class="input-group input-group-sm" >
                                    <div class="form-group-append">
                                        <a href="<?= base_url('Sakit/export') ?>" class="btn btn-primary active" aria-current="page">Excel</a>
                                        <a href="<?= base_url('Sakit/cetak') ?>" class="btn btn-primary active">PDF</a>
                                        <a href="<?= base_url('Sakit/print') ?>" class="btn btn-primary active">Print</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body table-responsive p-0" style="height: 100%;">
                            <div class="card-tools mt-3 ml-2">
                                <form action="<?= base_url('Sakit/searchdata') ?>" method="POST" class="input-group" style="width: 350px;">
