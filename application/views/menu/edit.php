        ...
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                <div class="form-group breadcrumb-right">
                    <div class="btn-group">
                        <a href="<?= base_url('menu') ?>" class="btn btn-primary active" aria-current="page">Back</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-10 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            // Notifikasi open
                            echo form_open_multipart(base_url('menu/edit/' . $menu->id), 'class="form form-vertical"');
                            ?>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Menu Management </label>
                                        <input type="text" class="form-control" name="menu" id="menu" value="<?= $menu->menu ?>" required />
                                    </div>
                                </div>
                                <div class="col-12">
