                ...
                <div class="col-10 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            // Notifikasi open
                            echo form_open_multipart(base_url('menu/editsubmenu/' . $subMenu->id), 'class="form form-vertical"');
                            ?>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Title </label>
                                        <input type="text" class="form-control" name="title" id="title" value="<?= $subMenu->title ?>" required />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Menu </label>
                                        <input type="text" class="form-control" name="menu_id" id="menu_id" value="<?= $subMenu->menu_id ?>" required />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>URL</label>
                                        <input type="text" class="form-control" name="url" id="url" value="<?= $subMenu->url ?>" required />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Icon </label>
                                        <input type="text" class="form-control" name="icon" id="icon" value="<?= $subMenu->icon ?>" required />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="is_active" id="is_active" placeholder="1 atau 0" value="<?= $subMenu->is_active ?>" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
