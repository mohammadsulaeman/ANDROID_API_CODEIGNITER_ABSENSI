                ...
                <div class="col-10 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            // Notifikasi open
                            echo form_open_multipart(base_url('user/edit/' . $users->id), 'class="form form-vertical"');
                            ?>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Email </label>
                                        <input type="text" class="form-control" name="email" id="email" placeholder="Email" readonly value="<?= $users->email ?>" required />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Full Name</label>
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Judul Berita" value="<?= $users->name?>" required />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Jabatan</label>
                                        <input type="text" class="form-control" name="jabatan" id="jabatan"  value="<?= $users->jabatan?>" required />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Status Kepegawaian</label>
                                        <input type="text" class="form-control" name="status" id="status"  value="<?= $users->status?>" required />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Pendidikan</label>
                                        <input type="text" class="form-control" name="pendidikan" id="pendidikan"  value="<?= $users->pendidikan?>" required />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="alamat" id="alamat"  value="<?= $users->alamat?>" required />
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Tempat, Tanggal Lahir</label>
                                        <input type="text" class="form-control" name="ttl" id="ttl"  value="<?= $users->ttl?>" required />
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="form-group">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <img src="<?php echo base_url('images/profile/' . $users->image) ?>" class="img-thumbnail rounded" height="80" width="80">
                                    </div>
                                </div>
                                <div class="col-12">
